  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        exp: {
          DEFAULT: "hsl(var(--exp))",
          background: "hsl(var(--exp-background))",
        },
        tier: {
          ...
          sapphire: "hsl(var(--tier-sapphire))",
      ...
      fontFamily: {
        ...
        brush: ["Satisfy", "Pacifico", "cursive"],
        calligraphy: ["Lobster", "cursive"],
        varsity: ["Bungee", "sans-serif"],
        gothic: ["UnifrakturMaguntia", "Metal Mania", "cursive"],
