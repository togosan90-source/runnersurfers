...
const sanitizeCssValue = (value: string): string | null => {
  ...
  // Only allow valid CSS color formats: hex, rgb, rgba, hsl, hsla, or CSS color names
  ...
  return validColorPattern.test(value.trim()) ? value.trim() : null;
};

// Sanitize CSS identifier (for chart id)
const sanitizeCssIdentifier = (id: string): string => {
  if (!id || typeof id !== 'string') return 'chart';
